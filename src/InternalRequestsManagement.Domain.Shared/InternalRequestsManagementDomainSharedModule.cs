...
public class InternalRequestsManagementDomainSharedModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<InternalRequestsManagementDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<InternalRequestsManagementResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/InternalRequestsManagement");

            options.DefaultResourceType = typeof(InternalRequestsManagementResource);
        ...
        {
            options.MapCodeNamespace("InternalRequestsManagement", typeof(InternalRequestsManagementResource));
        });
    }
}
