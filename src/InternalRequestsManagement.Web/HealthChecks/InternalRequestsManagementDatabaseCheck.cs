...
public class InternalRequestsManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InternalRequestsManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
